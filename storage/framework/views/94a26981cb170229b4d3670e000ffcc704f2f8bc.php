<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    ...
    <div class="col">
      <a class="btn btn-primary" href="/expense_reports/<?php echo e($report->id); ?>/confirmSendEmail">Enviar email</a>
    </div>
  </div>
  <div class="row">
    <div class="col|">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control-gastos\resources\views/expenseReport/show.blade.php ENDPATH**/ ?>